...
console.log('\n');
console.log('  ╔══════════════════════════════════════════════╗');
console.log('  ║   📘 FACEBOOK-ONLY TEST                      ║');
console.log('  ╚══════════════════════════════════════════════╝');
console.log('');

console.log('  🔑 Step 1: Verifying Facebook credentials...\n');
...
console.log('\n  ✅ Credentials verified! Connected to your Facebook Page.\n');
...
if (args.includes('--post')) {
  ...
  console.log('  To also send a TEST POST to your Facebook Page, run:');
  console.log('');
  console.log('    npm run fb:test-post');
  console.log('');
}

...
async function main() {
  console.log('\n');
  console.log('  ╔══════════════════════════════════════════════════╗');
  console.log('  ║   📘 FACEBOOK - ADD CONTENT                     ║');
  console.log('  ║   Create a new post for Facebook                 ║');
  console.log('  ╚══════════════════════════════════════════════════╝');
  console.log('');
...
`;
  ...
  console.log('\n  ✅ Content added to the Facebook queue!');
  console.log(`  📂 File: ${fileName}`);
  console.log(`  📍 Path: ${filePath}`);
  console.log('\n  Run "npm run fb:post" from the repo root or "npm run post-now" inside facebook/.\n');

...
async function main() {
  console.log('\n');
  console.log('  ╔══════════════════════════════════════════════════╗');
  console.log('  ║   📸 INSTAGRAM - ADD CONTENT                    ║');
  console.log('  ║   Create a new post for Instagram                ║');
  console.log('  ╚══════════════════════════════════════════════════╝');
  console.log('');

  const title = await ask('  📌 Post Title: ');
  const body = await ask('  📝 Caption / Body (one line): ');
  const link = await ask('  🔗 Link URL (optional, press Enter to skip): ');
  const hashtags = await ask('  #️⃣  Hashtags (comma separated, e.g. travel,sunset): ');
  const imageUrl = await ask('  🖼️  Image URL (recommended for Instagram): ');
...
`;
  ...
  console.log('\n  ✅ Content added to the Instagram queue!');
  console.log(`  📂 File: ${fileName}`);
  console.log(`  📍 Path: ${filePath}`);
  console.log('\n  Run "npm run ig:post" from the repo root.\n');

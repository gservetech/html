...
console.log('\n');
console.log('  ╔══════════════════════════════════════════════╗');
console.log('  ║   PRINT FACEBOOK TEST                       ║');
console.log('  ╚══════════════════════════════════════════════╝');
console.log('');

console.log('  🔑 Step 1: Verifying Print Facebook credentials...\n');
const verification = await verifyFacebook();

if (!verification.verified) {
  console.log('\n  ❌ Print Facebook credentials are invalid!');
  console.log(`  Reason: ${verification.reason}`);
  console.log('\n  Check your .env file:');
  console.log('  - FACEBOOK_PRINT_PAGE_ID');
  console.log('  - FACEBOOK_PRINT_PAGE_ACCESS_TOKEN');
  process.exit(1);
}

console.log('\n  ✅ Credentials verified! Connected to your Print Facebook Page.\n');
...
if (args.includes('--post')) {
  ...
  console.log('  To also send a TEST POST to your Print Facebook Page, run:');
  console.log('');
  console.log('    npm run fb:print:test-post');
  console.log('');
}

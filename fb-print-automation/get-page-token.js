...
const PAGE_ID_KEY = 'FACEBOOK_PRINT_PAGE_ID';
const PAGE_TOKEN_KEY = 'FACEBOOK_PRINT_PAGE_ACCESS_TOKEN';
...
console.log('\n');
console.log('  ╔══════════════════════════════════════════════════╗');
console.log('  ║   PRINT TOKEN HELPER                            ║');
console.log('  ║   Get the correct Print Page token              ║');
console.log('  ╚══════════════════════════════════════════════════╝');
console.log('');

const userToken = process.env[PAGE_TOKEN_KEY];

if (!userToken || userToken === 'your_print_long_lived_page_access_token_here') {
...
try {
  ...
  console.log('  ✅ Updated Print Facebook credentials in:');
  ...
  console.log('');
  console.log('  🚀 Now run: npm run fb:print:test-post');
  console.log('');
} catch (error) {

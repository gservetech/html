...
async function main() {
  console.log('\n');
  console.log('  ╔══════════════════════════════════════════════════╗');
  console.log('  ║   PRINT FACEBOOK - ADD CONTENT                  ║');
  console.log('  ║   Create a new post for the Print Page          ║');
  console.log('  ╚══════════════════════════════════════════════════╝');
  console.log('');
...
`;
  ...
  console.log('\n  ✅ Content added to the Print Facebook queue!');
  console.log(`  📂 File: ${fileName}`);
  console.log(`  📍 Path: ${filePath}`);
  console.log('\n  Run "npm run fb:print:post" from the repo root.\n');
